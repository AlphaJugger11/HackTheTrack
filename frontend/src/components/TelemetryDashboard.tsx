...
export function TelemetryDashboard({
  ...
  const brakeRear = telemetry.map((d: any) => d.pbrake_r || 0);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Throttle and Brake */}
      <div className="bg-gray-800 p-4 rounded-lg">
        <h4 className="text-lg font-semibold mb-3 text-white">Driver Inputs</h4>
        <Plot
          data={[
            {
              x: timestamps,
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gray-800 p-4 rounded-lg">
          <h4 className="text-lg font-semibold mb-3 text-white">Gear Usage</h4>
          <Plot
            data={[
              {
                x: timestamps,
